  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap uppercase text-white text-xs md:text-sm  ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary:
          "relative flex items-center justify-start  cursor-pointer    leading-[22px] box-border transition-all duration-300 ease-in-out shadow-[inset_0_50px_25px_-25px_hsl(205,59%,51%)] bg-[hsl(206,83%,33%)] hover:shadow-[inset_0_-3.21429em_hsl(206,83%,33%)]",
        secondary:
          "relative flex items-center justify-start  cursor-pointer   leading-[22px] box-border transition-all duration-300 ease-in-out shadow-[inset_0_50px_25px_-25px_#93c738] bg-[#658726] hover:shadow-[inset_0_-3.21429em_#658726]",
