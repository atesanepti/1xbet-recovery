  ...
  return (
    <div className="my-6 md:my-8 bg-secondary-foreground px-5 md:px-8 py-6 md:py-8 shadow-sm">
      ...
      <p className="text-[10px] md:text-xs text-muted mt-2 md:mt-3 w-[95%] md:w-[70%] mx-auto text-center">
        ...
        may discontinue services before changes take effect, at least two weeks
        after the announcement. While translations may be available, the English
        version prevails. 1xbet.com is operated by Caecus N.V., registered in
        Curaçao (163779) and licensed under OGL/2024/1262/0493 as of 07/11/2024.
        Payments are processed by Exidna Enterprises LTD (НЕ435756) and
        Kassifoni Enterprises LTD (НЕ435760). Users must also accept the
        Responsible Gaming Agreement (RGA) and its Gaming Terms of Service
        (GT&C), which include important restrictions for protection. Please
